...
const FILE_TYPE_LOGO_COLORS = {
  illustrator: "#FF9A00",
  markdown: "var(--muted-foreground)",
  pdf: "#ff2116",
  photoshop: "#31A8FF",
  photoshopBackground: "#001E36",
} as const;

export function fileTypeFromName(fileName: string): FileTypeIconType | null {
...
export function fileTypePreviewBackground(type?: FileTypeIconType | null) {
  const color =
    type === "pdf"
      ? FILE_TYPE_LOGO_COLORS.pdf
      : type === "ai" || type === "ait" || type === "eps"
        ? FILE_TYPE_LOGO_COLORS.illustrator
        : type === "psd" || type === "psb"
          ? FILE_TYPE_LOGO_COLORS.photoshop
          : type === "md"
            ? FILE_TYPE_LOGO_COLORS.markdown
            : undefined;

  return color ? `color-mix(in oklch, ${color} 12%, transparent)` : undefined;
}
...
const PdfIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill={FILE_TYPE_LOGO_COLORS.pdf}
...
const IllustratorIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      fill={FILE_TYPE_LOGO_COLORS.illustrator}
    />
    <path
...
const PhotoshopIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <rect
      ...
      height="80"
      rx="14.53"
      fill={FILE_TYPE_LOGO_COLORS.photoshopBackground}
    />
    <path
      ...
      fill={FILE_TYPE_LOGO_COLORS.photoshop}
    />
    <path
...
export function FileTypeIcon({
  ...
  if (type === "txt")
    return (
      <IconFileTextFilled
        className={cn("stroke-[1px]! text-muted-foreground/50", iconClassName)}
      />
    );
  if (type === "image" || type === "tiff")
    return <IconPhotoFilled className={cn("stroke-[1px]!", iconClassName)} />;
  return (
    <span
      className={cn(
